...
MESSAGES = {
    "en": {
        ...
        "doc_filter_progress": "Document filtering progress: {{progress_percent}}%，found {{relevant_count}}/{{total}} relevant documents",
    ...
    "zh": {
        ...
        "doc_filter_progress": "文档过滤进度：{{progress_percent}}%，找到 {{relevant_count}}/{{total}} 个相关文档",
