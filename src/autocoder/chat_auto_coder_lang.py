...
MESSAGES = {
    "en": {
        ...
        "commit_generating": "Generating commit message...",
        "commit_message": "Generated commit message:",
        "commit_failed": "Failed to generate commit message: {error}",
    },
    "zh": {
        "commit_generating": "正在生成提交信息...", 
        "commit_message": "生成的提交信息:",
        "commit_failed": "生成提交信息失败: {error}",
