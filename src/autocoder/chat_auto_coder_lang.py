...
MESSAGES = {
    "en": {
        ...
        "using_default_type": "will automatically collect extensions of code file, otherwise default to 'py'",
    ...
    "zh": {
        ...
        "using_default_type": "使用默认项目类型，会自动查找代码代码相关的后缀名，如果项目为空，则默认为py",
