...
MESSAGES = {
    "en": {
        ...
        "models_price_updated": "Updated price for model {{name}} to {{price}} M/token",
        "models_invalid_price": "Invalid price value: {{error}}",
        "models_price_usage": "Usage: /models /price <name> <value>",
    ...
    "zh": {
        ...
        "models_price_updated": "已更新模型 {{name}} 的价格为 {{price}} M/token",
        "models_invalid_price": "无效的价格值: {{error}}",
        "models_price_usage": "用法: /models /price <name> <value>",
