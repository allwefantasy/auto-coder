...
MESSAGES = {
    "en": {
        ...
        "model_provider_volcano_endpoint_title": "Volcano Engine Endpoint",
        "model_provider_volcano_endpoint_text": "Please enter your Volcano Engine endpoint (format: ep-20250204215011-vzbsg):",
        ...
        "model_provider_selected": "Provider configuration completed successfully!",
    ...
    "zh": {
        ...
        "model_provider_volcano_endpoint_title": "火山方舟接入点",
        "model_provider_volcano_endpoint_text": "请输入您的火山方舟接入点 (格式: ep-20250204215011-vzbsg)：",
        ...
        "model_provider_selected": "供应商配置已成功完成！",
