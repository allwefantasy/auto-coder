...
def main(input_args: Optional[List[str]] = None):
    ...
    serve_parser.add_argument("--monitor_mode", action="store_true", help="Monitor mode for the doc update")
    serve_parser.add_argument("--auto_window_adapt", action="store_true", default=True, help="Automatically merge or split documents for window adaptation")
