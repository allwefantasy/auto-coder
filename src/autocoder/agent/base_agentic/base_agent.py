...
class BaseAgent(ABC):
    ...
    def _system(self, request: AgentRequest) -> str:
        ...
        5. IMPORTANT: The write_to_file and replace_in_file tools are ONLY to be used for creating and updating research plans, search strategies, or summarizing findings. They are NOT to be used for modifying system files or any operational code. These tools should be limited to creating documentation of your research process and findings.
